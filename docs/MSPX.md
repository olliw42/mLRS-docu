...
- Link-Information such as RSSI, Link-Quality, SNR and more are provided to the Flight-Controller via MSP (Only INAV 8.0 and higher; Will be disabled automatically on unsupported firmwares; [More info](https://github.com/iNavFlight/inav/pull/10451))
