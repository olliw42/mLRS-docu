...
## mLRS Web Flasher App

The easiest way to flash firmware is the [mLRS Web Flasher](https://olliw.eu/mlrsflasher) app.

> [!TIP]
> It is strongly recommended to use this tool.
...
> [!NOTE]
> Sometimes one can find the "ST-LINK Utility" software being suggested. This software is totally outdated, and fully replaced by STM32CubeProgrammer. Please use STM32CubeProgrammer.
