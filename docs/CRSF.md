...
> [!NOTE] 
> 'x' refers to the serial port of your flight controller used for CRSF. This port is different (!) to the serial port used for the MAVLink serial stream.
...
> [!NOTE]
>  you should always install the latest dev / master version, previous releases aren't guaranteed to work.
